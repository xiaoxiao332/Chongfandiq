...
namespace LastLight
{
    public enum NodeKind { Pickup,Terminal,Depot,EmergencyStove,EmergencyBench,Pod,Liang,Core,Record,Shortcut,Travel,AidRoute,Bridge,Greenhouse,Sample,GreenhouseRecord }
