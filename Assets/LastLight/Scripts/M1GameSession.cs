...
namespace LastLight
{
    public sealed partial class M1GameSession : M1Session,IM1SessionUI
    {
        ...
        private void Update()
        {
            ...
            if(director.IsM2)TickM2(dt);if(director.IsM3)TickM3(dt);
        ...
        private string NavigationText()
        {
            ...
            else if(director.IsM3&&gameObject.scene.name=="Relay")destination=nodes.FirstOrDefault(n=>n.Kind==NodeKind.M3);
        ...
        public override void UseNode(M1Node node)
        {
            ...
            switch(node.Kind)
            {
                case NodeKind.M3:OpenM3Node(node);break;
