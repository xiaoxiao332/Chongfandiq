...
namespace LastLight
{
    public sealed partial class M1GameSession
    {
        ...
        {
            if(director.IsM3&&director.World.Data.bridge)return M3Objective();
        ...
        {
            var w=director.World.Data;director.World.Advance(dt,C,director.IsM3);
        ...
        public bool SleepUntilMorning(Building bed=null)
        {
            ...
            {
                float dt=Mathf.Min(1,seconds-elapsed);elapsed+=dt;director.World.Advance(dt,C,director.IsM3);
