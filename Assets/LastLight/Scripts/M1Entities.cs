...
namespace LastLight
{
    public enum NodeKind { Pickup,Terminal,Depot,EmergencyStove,EmergencyBench,Pod,Liang,Core,Record,Shortcut,Travel,AidRoute,Bridge,Greenhouse,Sample,GreenhouseRecord,M3 }
    public sealed class M1Node:MonoBehaviour
    {
        ...
        private float availableAt;private Renderer[] visuals;public NodeKind Kind=>kind;public string Label=>L.Resolve(label);
